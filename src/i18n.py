...
STRINGS: Dict[str, Dict[str, str]] = {
    ...
    "judge_api":         {"en": "Judge (Rubric Scoring) API",       "zh": "评分员 API"},
    ...
    "temperature":       {"en": "Temperature",                     "zh": "温度（Temperature）"},
    ...
    "upload_questions":  {"en": "Upload questions file (xlsx / json / jsonl / txt) — overrides data/",
                         "zh": "上传题目文件（xlsx / json / jsonl / txt）— 将覆盖 data/ 目录"},
    "upload_rubric":     {"en": "Upload rubric file (xlsx / json / jsonl / txt) — overrides data/",
                         "zh": "上传 Rubric 文件（xlsx / json / jsonl / txt）— 将覆盖 data/ 目录"},
    ...
    "saved_to":          {"en": "Saved {n} scores → `{path}`",
                         "zh": "已保存 {n} 条评分 → `{path}`"},
    "teaching_guidance": {"en": "Teaching Guidance",      "zh": "教师指导"},
    "student_answer":    {"en": "Student Answer",         "zh": "学生答案"},
    "student_baseline_answer":    {"en": "Before Teaching",  "zh": "指导前答案"},
    "student_intervention_answer":{"en": "After Teaching",   "zh": "指导后答案"},
    "step_baseline":     {"en": "① Student (Before)",    "zh": "① 学生（教学前）"},
    "step_teaching":     {"en": "② Teacher Guidance",    "zh": "② 教师指导"},
    "step_intervention": {"en": "③ Student (After)",     "zh": "③ 学生（教学后）"},
    "baseline_score":    {"en": "Score Before",          "zh": "教学前得分"},
    "intervention_score":{"en": "Score After",           "zh": "教学后得分"},
    "score_improve":     {"en": "Improvement",           "zh": "提升幅度"},
    "judge_result":      {"en": "Judge Result",          "zh": "评分结果"},
    "weighted_total":    {"en": "Weighted Total",        "zh": "加权总分"},
    "weighted":          {"en": "Weighted",             "zh": "加权得分"},
    "dim_breakdown":     {"en": "Dimension Breakdown",  "zh": "维度得分明细"},
    "question":          {"en": "Question",   "zh": "题目"},
    "score":             {"en": "Score",       "zh": "得分"},
    "rationale":         {"en": "Rationale",   "zh": "评分理由"},
    "clear_cache":       {"en": "Clear uploaded data", "zh": "清除已上传数据"},
